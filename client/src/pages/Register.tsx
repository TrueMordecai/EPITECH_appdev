...
const Register = () => {
    ...
    const updatePwd = (d: string) => {
        password = d
    }

    const updateEmail = (d: string) => {
        mail = d
    }
                ...
                <div className="window-body">
                    <p>
                        <form onSubmit={submit}>
                            ...
                            <div>
                                <label style={{ textDecoration: "underline", cursor: "pointer" }} onClick={goLogin}>Already have an account ? Login here</label>
                            </div>
                        </form>
                    </p>
                </div>
